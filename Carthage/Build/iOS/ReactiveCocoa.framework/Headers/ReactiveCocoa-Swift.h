...
/**
  Wraps an Action for use by a GUI control (such as \code
  NSControl
  \endcode or
  \code
  UIControl
  \endcode), with KVO, or with Cocoa Bindings.
*/
...
/**
  ...
  execute it.
*/
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) SEL _Nonnull selector;)
...
@interface CocoaAction (SWIFT_EXTENSION(ReactiveCocoa))
@end


SWIFT_CLASS("_TtC13ReactiveCocoa16KeyValueObserver")
@interface KeyValueObserver : NSObject
@property (nonatomic, readonly, unsafe_unretained) NSObject * _Nonnull unsafeObject;
@property (nonatomic, readonly, copy) NSString * _Nonnull key;
@property (nonatomic, readonly, copy) void (^ _Nonnull action)(id _Nullable object);
- (void)detach;
- (void)observeValueForKeyPath:(NSString * _Nullable)keyPath ofObject:(id _Nullable)object change:(NSDictionary<NSKeyValueChangeKey, id> * _Nullable)change context:(void * _Nullable)context;
@end


@interface KeyValueObserver (SWIFT_EXTENSION(ReactiveCocoa))
@end
